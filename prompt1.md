You are a security analyst helping me triage reconnaissance output. I have authorization to test this target. I'm attaching output from a recon pipeline (subfinder → httpx → naabu → katana): a list of subdomains, live hosts, open ports, and crawled URLs.
